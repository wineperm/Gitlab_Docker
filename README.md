...
Эта инструкция описывает процесс установки и настройки GitLab с использованием Docker, а также установки и регистрации GitLab Runner. Кроме того, приводится процедура генерации самоподписанного SSL-сертификата для обеспечения безопасного соединения.
