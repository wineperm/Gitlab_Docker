...
Эта инструкция описывает процесс установки и настройки [GitLab с использованием Docker](https://github.com/wineperm/Gitlab_Docker/blob/main/README.md#установка-gitlab), а также установки и регистрации GitLab Runner. Установка GitLab Runner может быть выполнена как на [отдельном сервере](https://github.com/wineperm/Gitlab_Docker/blob/main/README.md#установка-gitlab-runner), так и с помощью [скрипта в Docker контейнере находящимся на другом хосте](https://github.com/wineperm/Gitlab_Docker/blob/main/README.md#создание-скрипта-setup-gitlab-runnersh) или [скрипта на этом же хосте где и GitLab](https://github.com/wineperm/Gitlab_Docker/blob/main/README.md#созданиеустановкарегистрация-gitlab-runner-в-docker-на-том-же-хосте-что-и-gitlab). Кроме того, приводится процедура [генерации самоподписанного SSL-сертификата](https://github.com/wineperm/Gitlab_Docker/blob/main/README.md#создание-файла-конфигурации-opensslcnf) для обеспечения безопасного соединения.
...
Этот скрипт автоматизирует процесс установки и настройки GitLab Runner в Docker на другом хосте, что GitLab. Следуйте инструкциям на экране для ввода необходимых данных.
